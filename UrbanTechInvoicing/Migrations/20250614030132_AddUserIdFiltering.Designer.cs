...
namespace UrbanTechInvoicing.Migrations
{
    ...
    [Migration("20250614030132_AddUserIdFiltering")]
    partial class AddUserIdFiltering
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CustomerId = new Guid("9ea35b29-3d63-4970-863a-c2b527be66fa"),
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InvoiceId = new Guid("7ceca875-6d88-4600-ac25-9c2f708ae405"),
                            CustomerId = new Guid("9ea35b29-3d63-4970-863a-c2b527be66fa"),
                            DueDate = new DateTime(2025, 7, 14, 3, 1, 31, 619, DateTimeKind.Utc).AddTicks(9240),
                            InvoiceDate = new DateTime(2025, 6, 14, 3, 1, 31, 619, DateTimeKind.Utc).AddTicks(9238),
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.InvoicePayments", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InvoiceId = new Guid("7ceca875-6d88-4600-ac25-9c2f708ae405"),
                            PaymentId = new Guid("deaae9cc-e4d9-4924-bc85-7c478bd2e7f3"),
                            PaymentAmount = 1000.00m,
                            PaymentDate = new DateTime(2025, 6, 14, 3, 1, 31, 619, DateTimeKind.Utc).AddTicks(9441)
                        });
                });
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.Payments", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InvoiceId = new Guid("7ceca875-6d88-4600-ac25-9c2f708ae405"),
                            PaymentAmount = 1000.00m,
                            PaymentDate = new DateTime(2025, 6, 14, 3, 1, 31, 619, DateTimeKind.Utc).AddTicks(9421),
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = new Guid("36679e0d-1614-4d56-a78a-c4d2ef6cb114"),
            ...
            modelBuilder.Entity("UrbanTechInvoicing.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServiceId = new Guid("e213a62c-319a-46ef-9940-8268df11fbf5"),
